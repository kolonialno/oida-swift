...
/// The configuration struct. User-defined in the `.oida.yml` file, it drives what the tool enforces.
public struct Configuration {
    ...
    public static let defaultFileName = ".oida.yml"
    ...
    /// was used to explicitly specify the default `.oida.yml` as the configuration file
